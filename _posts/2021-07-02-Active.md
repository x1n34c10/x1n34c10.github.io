...
Ahora solo faltaba la escalada de privilegios, tenía Kerberos abierto, por lo que probé a "dumpear" el Tiquet de servicio del usuario Administrador mediante la herramienta `GetUserSPNs.py`.
...
Perfecto ya lo teníamos, le hice fuerza bruta con "john the ripper" y con un poco de suerte conseguí desencriptarlo.
