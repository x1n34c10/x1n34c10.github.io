...
layout: single
excerpt: "Esta máquina es de dificultad fácil, me gusto en especial porque se tocaban temas de directorio activo, para su intrusión me aproveche de un archivo de disco duro virtual, pude dumpear hashes y craquearlos con john, me sirvieron para acceder. Para la escalada de privilegios encontré una archivo llamado consConf.xml que tenía un clave codificada, tras decodificarla me permitió escalar como el usuario root."
header:
show_date: true
classes: wide
header:
